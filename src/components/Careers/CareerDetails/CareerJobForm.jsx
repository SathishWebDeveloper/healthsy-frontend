...
import PhoneFormInput from "../../DoctorRegistration/Partials/PhoneFormInputNew";
...
const CareerJobForm = ({ jobDetails: data }) => {
  ...
  const onSubmit = (fields) => {
    ...
    */
    ...
    fieldKeys.forEach((key) => {
      if (!key.includes("hyperLink")) {
        tempFields[key] = fields[key];
      }
    });
    tempFields.hyperLink = fieldKeys.map(key => {
      if (!key.includes("hyperLink")) {
        return
      }
    })
    const updatedFields = { ...fields, location: data.job_Location, jobPosition: data.designation, hyperLink: hyperLinks }
  ...
  return (
    <>
      <div
        className=" jobapply container jobformWrapper mb-5 mt-0"
        id="jobapply"
      >
        <div className=" ">
          <div className="">
            ...
            >
              <div className="">
                <div className="careerDetailSubheader mb-3">Join us in the Health tech revolution!</div>
                    ...
                    <div className="col-md-12">
                      <div className="row">                        
                        <div className="mb-32 col-md-12">
                          <label>
                            Full Name <span className="color-mandatory">*</span>
                          </label>
                          <div>
                            <input
                              type="text"
                        ...
                        <div className="col-md-12">
                          ...
                          {otp_status === enum_otp_status.OTP_SENT && (
                            <div className={`col-12 col-md-12 mb-3`}>
                              ...
                              <div className="row">
                                <div className="col-12 col-md-11 d-flex verifyOTP">
                                  <input
                                    type="number"
                                  ...
                                  <button
                                    className={`btn py-2 px-4 ${otp_status ===
                                      ...
                                      : otp1.concat(otp2, otp3, otp4)
                                        ...
                                        ? "get-code"
                                        : ""
                                      } rounded-4 border-0 verification-btn`}
                                    disabled={
                              ...
                              >
                                ...
                                >
                                  <input
                                    ...
                                    placeholder="Portfolios / Behance / Dribbble / Github /
                                      Website / LinkedIn / Blogs"
                        ...
                        <div className="mb-32 col-md-12">
                          ...
                          <div>
                            <input
                              ...
                              placeholder="Educational Qualification / Institution Attented"
                              className="form-control"
                            // autoFocus
                            />
                        ...
                        <div className="mb-32 col-md-6">
                          <div className="upload-btn">
                            ...
                            <div>
                              <span className="primaryColor attachText">Attach{" "}</span>
                              <button className="upload-resume-btn ms-2">
                                {" "}
                                <img
                                  src={
