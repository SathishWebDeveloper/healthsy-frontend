...
const UserGeneralForm = () => {
    ...
    const onSubmit = (fields) => {
        ...
        if (!newLocation) {
            ...
            axios
                .post(
                    `${process.env.NEXT_PUBLIC_APP_API_URL}user-general/user-general-create`,
                    fields
                )
                .then((response) => {
                    if (response.status === 200) {
                        ...
                        router.push({
                            pathname: '/ad-landing-page-users-general/thank-you',
                            query: { id: adId }
                        },
    ...
    return (
        <>
            ...
            <div className="container">
                <div className="instaDocContainer userGeneralFormWrapper">
